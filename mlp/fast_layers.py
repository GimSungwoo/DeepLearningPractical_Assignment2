import numpy as np
# try:
#   from mlp.im2col_cython import col2im_cython, im2col_cython
# except ImportError:
...
def conv_backward_params_fast(dout, cache):
  """
  A fast implementation of the backward pass for a convolutional layer
  based on im2col and col2im.
  """
...
# generate cache for bprop
def max_pool_forward_cache_im2col(x, pool_param):
  """
  An implementation of the forward pass for max pooling based on im2col.
